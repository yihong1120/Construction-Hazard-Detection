...
from examples.YOLOv8_data_augmentation.visualise_bounding_boxes import (
    BoundingBoxVisualiser,
)
from examples.YOLOv8_data_augmentation.visualise_bounding_boxes import main
...
class TestBoundingBoxVisualiser(unittest.TestCase):
    ...
    @patch(
        'examples.YOLOv8_data_augmentation.visualise_bounding_boxes.'
