...
class FetchModelTests(BaseModelTest):
    ...
    async def test_fetch_model_success(self, mock_path: Any) -> None:
    ...
    @patch('examples.mcp_server.tools.model.Path')
    async def test_fetch_model_failure(self, mock_path: Any) -> None:
    ...
    async def test_fetch_model_exception_logs(self, mock_logger: Any) -> None:
...
class ListAvailableModelsTests(BaseModelTest):
    ...
    @patch('examples.mcp_server.tools.model.logging.getLogger')
    async def test_list_models_exception(self, mock_logger: Any) -> None:
...
class GetModelInfoTests(BaseModelTest):
    ...
    @patch('examples.mcp_server.tools.model.Path')
    async def test_get_model_info_found(self, mock_path: Any) -> None:
    ...
    @patch('examples.mcp_server.tools.model.Path')
    async def test_get_model_info_not_found(self, mock_path: Any) -> None:
    ...
    @patch('examples.mcp_server.tools.model.logging.getLogger')
    async def test_get_model_info_exception(self, mock_logger: Any) -> None:
...
class UpdateModelTests(BaseModelTest):
    ...
    @patch('examples.mcp_server.tools.model.Path')
    async def test_update_model_success(self, mock_path: Any) -> None:
    ...
    @patch('examples.mcp_server.tools.model.Path')
    async def test_update_model_failure(self, mock_path: Any) -> None:
    ...
    @patch('examples.mcp_server.tools.model.logging.getLogger')
    async def test_update_model_exception(self, mock_logger: Any) -> None:
...
class ValidateModelTests(BaseModelTest):
    ...
    @patch('examples.mcp_server.tools.model.Path')
    async def test_validate_model_exists(self, mock_path: Any) -> None:
    ...
    @patch('examples.mcp_server.tools.model.Path')
    async def test_validate_model_not_exists(self, mock_path: Any) -> None:
    ...
    @patch('examples.mcp_server.tools.model.logging.getLogger')
    async def test_validate_model_exception(self, mock_logger: Any) -> None:
        """Should log and raise on exception."""
        logger = mock_logger.return_value
        with patch.object(
            ModelTools,
...
class GetLocalModelsTests(BaseModelTest):
    ...
    @patch('examples.mcp_server.tools.model.Path')
    async def test_get_local_models_scans_files(self, mock_path: Any) -> None:
    ...
    @patch('examples.mcp_server.tools.model.logging.getLogger')
    async def test_get_local_models_exception(self, mock_logger: Any) -> None:
...
class CleanupOldModelsTests(BaseModelTest):
    ...
    async def test_cleanup_old_models_success(self) -> None:
    ...
    @patch('examples.mcp_server.tools.model.logging.getLogger')
    async def test_cleanup_old_models_exception(
...
class EnsureModelFetcherTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_initialises_model_fetcher_once(self) -> None:
