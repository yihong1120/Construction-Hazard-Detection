...
class BffRouterTest(unittest.TestCase):
    ...
    @patch('examples.bff.router.login_user')
    def test_login_and_session_never_expose_tokens(
        ...
        session_id = response.cookies[bff.SESSION_COOKIE]
    ...
    def test_session_refreshes_server_token_and_rolls_cookie(self) -> None:
        ...
        with patch(
            'examples.bff.router.get_proxy_access_token',
    ...
    def test_csrf_and_origin_protect_logout(
        ...
        session_id = login.cookies[bff.SESSION_COOKIE]
        cookies = {bff.SESSION_COOKIE: session_id}
        ...
        with patch(
            'examples.bff.router.logout_user',
            new_callable=AsyncMock,
        ):
    ...
    def test_service_proxy_path_does_not_repeat_api(self) -> None:
        ...
        with patch(
            'examples.bff.router.proxy_request',
            new_callable=AsyncMock,
