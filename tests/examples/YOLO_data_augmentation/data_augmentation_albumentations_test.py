...
import numpy as np
from examples.YOLO_data_augmentation.data_augmentation_albumentations import DataAugmentation, main
...
class TestDataAugmentation(unittest.TestCase):
    ...
    @patch('examples.YOLO_data_augmentation.data_augmentation_albumentations.cv2.imread')
    @patch('examples.YOLO_data_augmentation.data_augmentation_albumentations.cv2.cvtColor')
    def test_augment_image(self, mock_cvtColor: MagicMock, mock_imread: MagicMock) -> None:
        ...
        with patch.object(self.augmenter, 'read_label_file', return_value=(mock_class_labels, mock_bboxes)):
            with patch.object(self.augmenter, 'write_label_file') as mock_write_label_file:
                with patch('examples.YOLO_data_augmentation.data_augmentation_albumentations.cv2.imwrite') as mock_imwrite:
    ...
    @patch('examples.YOLO_data_augmentation.data_augmentation_albumentations.cv2.imread')
    @patch('examples.YOLO_data_augmentation.data_augmentation_albumentations.cv2.cvtColor')
    @patch('examples.YOLO_data_augmentation.data_augmentation_albumentations.cv2.imwrite')
    ...
    @patch('examples.YOLO_data_augmentation.data_augmentation_albumentations.random.shuffle')
