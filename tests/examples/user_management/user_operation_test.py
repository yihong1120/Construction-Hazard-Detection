...
from examples.user_management.user_operation import add_user, delete_user, update_username, update_password


class UserOperationTestCase(unittest.TestCase):
    """
    Unit tests for user operations (add, delete, update username, update password).
    """
    ...
    def test_update_username_success(self) -> None:
        ...
        with self.app.app_context():
            ...
            self.assertEqual(response, "Username updated successfully to newusername.")
    ...
    def test_update_password_success(self) -> None:
        ...
        with self.app.app_context():
            ...
            self.assertEqual(response, "Password updated successfully for user testuser.")
