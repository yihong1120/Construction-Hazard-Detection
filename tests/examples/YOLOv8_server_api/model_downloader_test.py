...
from examples.YOLOv8_server_api.model_downloader import models_blueprint
...
class ModelDownloaderTestCase(unittest.TestCase):
    ...
    def test_download_model_up_to_date(
        ...
        with patch(
            'examples.YOLOv8_server_api.model_downloader.Path.stat',
        ) as mock_stat:
            ...
            with patch(
                'examples.YOLOv8_server_api.model_downloader.Path.exists',
                return_value=True,
            ):
