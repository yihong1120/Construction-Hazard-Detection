...
LANGUAGES = {
    'en-GB': {
        ...
        'warning_no_mask': 'Warning: {count} people are not wearing a mask!',
    ...
    'zh-TW': {
        ...
        'warning_no_hardhat': '警告: 有{count}人未佩戴安全帽!',
        'warning_no_safety_vest': '警告: 有{count}人未穿著安全背心!',
        'warning_no_mask': '警告: 有{count}人未佩戴口罩!',
        'warning_close_to_machinery': '警告: 有{count}人過於靠近機具!',
        'warning_close_to_vehicle': '警告: 有{count}人過於靠近車輛!',
        'warning_people_in_utility_pole_controlled_area': (
            '警告: 有{count}人進入電桿管制區!'
        ),
        'detect_machinery_close_to_pole': '警告: 有{count}個機具過於靠近電桿!',
        'no_warning': '無警告',
        'machinery': '機具',
        'vehicle': '車輛',
        'helmet': '安全帽',
    ...
    'zh-CN': {
        ...
        'warning_no_hardhat': '警告: 有{count}人未佩戴安全帽!',
        'warning_no_safety_vest': '警告: 有{count}人未穿着安全背心!',
        'warning_no_mask': '警告: 有{count}人未佩戴口罩!',
        'warning_close_to_machinery': '警告: 有{count}人过于靠近机械!',
        'warning_close_to_vehicle': '警告: 有{count}人过于靠近车辆!',
        'warning_people_in_utility_pole_controlled_area': (
            '警告: 有{count}人进入电桿管制区!'
        ),
        'detect_machinery_close_to_pole': '警告: 有{count}个机械过于靠近电桿!',
        'no_warning': '无警告',
        'machinery': '机械',
        'vehicle': '车辆',
        'helmet': '安全帽',
    ...
    'fr-FR': {
        ...
        'warning_no_safety_vest': (
            'Avertissement: {count} personnes ne portent pas de gilet de '
            'sécurité!'
        ),
        'warning_no_mask': (
        ...
        'warning_close_to_machinery': (
            'Avertissement: Il y a {count} personnes trop proches de la '
            'machinerie!'
        ),
        'warning_close_to_vehicle': (
    ...
    'vi-VN': {
        ...
        'warning_no_mask': 'Cảnh báo: Có {count} người không đeo khẩu trang!',
        'warning_close_to_machinery': (
    ...
    'id-ID': {
        ...
        'warning_no_safety_vest': (
            'Peringatan: Ada {count} orang tidak mengenakan rompi keselamatan!'
        ),
        'warning_no_mask': (
        ...
        'detect_machinery_close_to_pole': (
            'Peringatan: Ada {count} mesin terlalu dekat dengan tiang listrik!'
        ),
    ...
    'th-TH': {
        ...
        'warning_no_hardhat': 'คำเตือน: มี {count} คนไม่สวมหมวกนิรภัย!',
        'warning_no_safety_vest': (
            'คำเตือน: มี {count} คนไม่สวมเสื้อกั๊กนิรภัย!'
        ),
        'warning_no_mask': 'คำเตือน: มี {count} คนไม่สวมหน้ากากอนามัย!',
        'warning_close_to_machinery': (
    ...
    'ja-JP': {
        'warning_people_in_controlled_area': '警告: {count}人が管理区域に入りました!',
        'warning_no_hardhat': '警告: {count}人がヘルメットを着用していません!',
        'warning_no_safety_vest': '警告: {count}人が安全ベストを着用していません!',
        'warning_no_mask': '警告: {count}人がマスクを着用していません!',
        'warning_close_to_machinery': '警告: {count}人が重機に近づきすぎています!',
        'warning_close_to_vehicle': '警告: {count}人が車両に近づきすぎています!',
        'warning_people_in_utility_pole_controlled_area': (
            '警告: {count}人が電柱制限区域に入りました!'
        ),
        'detect_machinery_close_to_pole': '警告: {count}台の重機が電柱に近づきすぎています!',
        'no_warning': '警告なし',
        'machinery': '重機',
        'vehicle': '車両',
        'helmet': 'ヘルメット',
...
class Translator:
    ...
    The service accepts only keys present in ``LANGUAGES``; this class
    therefore performs direct template rendering without locale fallback
    behaviour.
    """
