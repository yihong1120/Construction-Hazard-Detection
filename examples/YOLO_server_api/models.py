...
from examples.YOLO_server_api.config import EXPLICIT_CUDA_CLEANUP
from examples.YOLO_server_api.config import get_inference_device
from examples.YOLO_server_api.config import LAZY_LOAD_MODELS
from examples.YOLO_server_api.config import MAX_LOADED_MODELS
from examples.YOLO_server_api.config import MODEL_VARIANTS
